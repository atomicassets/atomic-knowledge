---
scope: Complete table reference for the AtomicTools contract at account `atomictoolsx` - the links and config tables, their row shapes, and how both are scoped
