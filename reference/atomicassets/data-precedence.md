...
Source: `include/atomicdata.hpp:46` (`RESERVED`), `include/atomicdata.hpp:488-510` (`serialize`), `include/atomicdata.hpp:492-493` (skip-if-absent), `include/atomicdata.hpp:513-524` (`deserialize`), `include/atomicdata.hpp:519` (identifier-to-format lookup), `include/checkformat.hpp` (format validity, re-checked on every `extendschema` call)
